        ...
        <div class="card-body">
            <div class="d-flex align-items-center">
                ...
                <div class="dropdown ms-auto d-flex">
                    <a href="{{route('nvr.create')}}" class="btn btn-primary px-2 me-2"><i class="bx bx-plus mr-1"></i>Thêm NVR</a>
                ...
                <table class=" table table-bordered table-striped" id="datatable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class=" text-center">
                                <a class="btn btn-sm btn-warning px-2 me-1" href="{{route('nvr.edit', $item->id)}}">
                                    <i class="bx bx-edit-alt  me-0"></i>
                                </a>
                                <form method="POST" style="display: inline-block" class="" id="del_form_{{$item->id}}" action="{{route('nvr.destroy', $item->id )}}">
                                    @csrf
                                    @method('delete')
