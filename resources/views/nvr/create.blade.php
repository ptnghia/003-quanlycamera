                ...
                <div class="card-body p-5 pt-3">
                    ...
                    <form class="row g-3" method="POST" action="{{route('nvr.store')}}"> 
                        ...
                        <div class="col-md-8 col-12">
                            ...
                            <input type="text" class="form-control @error('name') is-invalid @enderror"  value="{{ old('name') }}" name="name" id="name" placeholder="Nhập tên thiết bị">
                            @error('name')
                        ...
                        <div class="col-md-4 col-12">
                            ...
                            <select class="form-select" name="status">
                                <option {{  old('area_id')==1 ?'selected':'' }} value="1">Đang hoạt động</option>
                                <option {{  old('area_id')==0 ?'selected':'' }} value="0">Ngừng hoạt động</option>
                            </select>
                        </div>
                        <div class="col-md-4 col-12">
                            <label class="form-label">IP</label>
                            <input type="text" class="form-control @error('ip') is-invalid @enderror"  value="{{ old('ip') }}" name="ip" placeholder="Nhập địa chỉ IP">
                            @error('ip')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="col-md-4 col-12">
                            ...
                            <input type="text" class="form-control @error('port') is-invalid @enderror"  value="{{ old('port') }}" name="port" placeholder="Nhập Port">
                            @error('port')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="col-md-4 col-12">
                            ...
                            <input type="text" class="form-control @error('serial') is-invalid @enderror"  value="{{ old('serial') }}" name="serial" placeholder="Nhập Serial" >
                            @error('serial')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="col-md-8 col-12">
                            ...
                            <select class=" form-control select2" name="area_id">
                                ...
                                <option {{  old('area_id') == $row->id ?'selected':'' }} value="{{$row->id}}">{{$row->name}}</option>
                                @endforeach
                            </select>
                            @error('area_id')
                                <span class="invalid-feedback" role="alert">
                        ...
                        <div class="col-md-4 col-12">
                            ...
                            <input type="text" class="form-control @error('version') is-invalid @enderror"  value="{{ old('version') }}" name="version" placeholder="Nhập phiên bản" >
                            @error('version')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="col-12">
                            ...
                            <textarea class=" form-control  @error('note') is-invalid @enderror" name="note" rows="4" placeholder="Nhập ghi chú...">{{ old('note') }}</textarea>
                            @error('note')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
