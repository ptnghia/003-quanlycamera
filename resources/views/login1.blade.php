										...
										<form class="row g-3" method="POST" action="{{ route('login') }}">
											...
											<div class="col-12">
												...
												<div class="input-group" id="show_hide_password">
													<input type="password" class="form-control border-end-0" id="inputChoosePassword" value="" placeholder="Nhập mật khẩu"> <a href="javascript:;" class="input-group-text bg-transparent"><i class='bx bx-hide'></i></a>
												</div>
											</div>
											<div class="col-md-6">
											...
											<div class="col-12">
												<div class="d-grid">
													<button onclick="window.location='{{route('index')}}'" type="button" class="btn btn-primary"><i class="bx bxs-lock-open"></i>Đăng nhập</button>
												</div>
											</div>
										</form>
									</div>
