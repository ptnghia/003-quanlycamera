                    ...
                    <form class="row g-3">
                        ...
                        <div class="col-md-4 col-12">
                            ...
                            <select class="form-select">
                                <option value="1">Biển số xe</option>
                                <option value="2">Khuôn mặt</option>
                            </select>
                        </div>
                        <div class="col-md-6 col-12">
                            <label for="inputtime" class="form-label">Thời gian</label>
                            <input type="datetime-local" class="form-control" id="inputtime" value="{{date('Y-m-d H:i:s', time())}}">
                        </div>
                        <div class="col-md-6 col-12">
                            <label class="form-label">Phân loại</label>
                            <select class="form-select">
                                <option value="1">Danh sách đen</option>
