...
<div class="page-content">
    ...
    <div class="card radius-10">
        <div class="card-body">
            <p><b><i class="bx bx-user me-2 font-18"></i>Nguyễn Trung Tín</b></p>
            <div class="d-flex align-items-center">
                <div class=" card-img">
                    <img class="radius-10" width="100px" height="100px" src="{{asset('assets/images/avatars/avatar-1.png')}}" />
                </div>
                <div class="dropdown ms-auto d-flex">
                    <div class=" card-img me-2">
                        <img class="radius-10" width="100px" height="100px" src="{{asset('assets/images/avatars/avatar-2.png')}}" />
                    </div>
                    <div class=" card-img me-2">
                        <img class="radius-10" width="100px" height="100px" src="{{asset('assets/images/avatars/avatar-3.png')}}" />
                    </div>
                    <div class=" card-img me-2">
                        <img class="radius-10" width="100px" height="100px" src="{{asset('assets/images/avatars/avatar-4.png')}}" />
                    </div>
                    <div class=" card-img me-2">
                        <img class="radius-10" width="100px" height="100px" src="{{asset('assets/images/avatars/avatar-5.png')}}" />
                    </div>
                </div>
            </div>
            <hr>
                ...
                <table class=" table table-bordered table-striped">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <button type="button" class="btn btn-sm btn-info" data-bs-toggle="modal" data-bs-target="#Modal_khuonmat">
...
<div class="modal fade" id="Modal_khuonmat" tabindex="-1" aria-hidden="true">
