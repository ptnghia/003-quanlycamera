                    ...
                    <div class="card-body p-5 pt-3">
                        ...
                        @method('POST')
                            <div class="col-md-8 col-12">
                                ...
                                <input type="text" class="form-control" name="name" id="inputLastName1"
                                    placeholder="Nhập tên đối tượng cần giám sát">
                            </div>
                            ...
                            <div class="col-md-3 col-12">
                                ...
                                <input type="text" class="form-control" name="IP" placeholder="Nhập địa chỉ IP"
                                    value="">
                            </div>
                            <div class="col-md-3 col-12">
                                <label class="form-label">Link</label>
                                <input type="text" class="form-control" name="link" placeholder="Nhập địa chỉ IP"
                                    value="">
                            </div>
                            <div class="col-md-3 col-12">
                            ...
                            <div class="col-12 d-flex justify-content-between">
                                <a class="btn btn-sm btn-primary" href=""><i
                                        class="bx bx-arrow-back me-1 font-13"></i>Quay lại</a>
                                <button type="submit" class="btn btn-primary px-5"><i class="bx bx-save me-1"></i>Cập
                                    nhật</button>
                            </div>
                        </form>
                    </div>
