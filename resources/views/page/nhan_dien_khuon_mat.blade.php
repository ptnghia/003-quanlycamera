...
<div class="page-content">
    ...
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        <div class="breadcrumb-title pe-3">Nhận diện khuôn mặt</div>
        <div class="ps-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Nhận diện khuôn mặt</li>
                </ol>
            </nav>
        </div>
    </div>
                ...
                <table class=" table table-bordered table-striped">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                Phát hiện khuôn mặt trong danh sách đen
                            </td>
                            <td>
                                12-09-2022 22:01:03
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                Phát hiện đối tượng trong danh sách đen
                            </td>
                            <td>
                                12-09-2022 22:01:03
                            </td>
