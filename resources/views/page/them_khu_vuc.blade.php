        ...
        <div class="ps-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Thêm mới khu vực</li>
                </ol>
            </nav>
        </div>
    </div>
            ...
            <div class="card border-top border-0 border-4 border-primary">
                <div class="card-body p-5 pt-3">
                    <div class="card-title d-flex align-items-center">
                        ...
                        <h5 class="mb-0 font-weight-bold" style="font-size: 16px">Thêm khu vực</h5>
                    </div>
                    <hr>
                    <form class="row g-3" method="POST" action="{{route('area.store')}}">
                        @csrf
                        @method('POST')
                        <div class="col-12">
                            <label for="inputLastName1" class="form-label">Tên khu vực</label>
