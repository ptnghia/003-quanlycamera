        ...
        <div class="col-lg-7 col-12">
            <div class="card border-top border-0 border-4 border-primary">
                <div class="card-body p-5 pt-3">
                    ...
                    @endif
                    <form class="row g-3" method="POST" action="{{route('thanh-vien.store')}}"> 
                        @csrf
                        <div class="col-12">
                            <label for="inputLastName1" class="form-label">Họ tên</label>
                            <input type="text" class="form-control  @error('name') is-invalid @enderror"  value="{{ old('name') }}"  name="name" id="inputLastName1"  placeholder="Nhập họ tên">
                            @error('name')
                        ...
                        <div class="col-md-4 col-12">
                            ...
                            <input type="text" class="form-control  @error('code') is-invalid @enderror"  value="{{ old('username') }}"  name="username"  placeholder="Nhập số định danh" >
                            @error('username')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="col-md-4 col-12">
                            ...
                            <input type="email" class="form-control @error('email') is-invalid @enderror"  value="{{ old('email') }}"  name="email"  placeholder="Nhập email" >
                            @error('email')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="col-12">
                            ...
                            {!! Form::select('roles[]', $roles,[], array('value' => '{{ old("roles") }}', 'class' => 'form-control multiple-select2','multiple')) !!}
